...
export default function CookieInformation() {
  return <article className="site-container cookie-information">
    ...
    <p>Greater Chatham Culinary Trail uses the following browser storage. You can change your choice using Cookie settings in the footer.</p>
    <h2>Necessary cookies</h2>
    <p>The gci_cookie_preferences cookie records your cookie choice for up to 180 days. It does not contain your name or a visitor identifier. Administrators who sign in receive a separate authentication cookie lasting up to 12 hours.</p>
    <h2>Optional favorites storage</h2>
    <p>If you allow “Remember favorites,” restaurant IDs are saved in this browser’s local storage under chatham-saved-kitchens-v1. This list is not sent to our server. It remains until you clear it, clear browser data, or turn this option off. If you choose “Only necessary,” favorites work for the current visit and are lost when you reload or leave.</p>
