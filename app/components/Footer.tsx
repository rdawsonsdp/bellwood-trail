...
export function Footer() {
  return <footer className="discovery-footer"><div className="site-container footer-main">
    ...
    <nav aria-label="Footer navigation"><h2>Make a day of it</h2><a href="#path">Explore the kitchens</a><a href={SITE.instagram} target="_blank" rel="noopener noreferrer">Follow Greater Chatham</a></nav>
